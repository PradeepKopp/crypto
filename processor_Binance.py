...
class BinanceProcessor():
    def __init__(self):
        ...
        self.binance_api_key = "5fO5Zzgs6NUyY9xy5KQvk0Ru3cB1eg8NYGqoaRT8npFEuYLuFw0QgSSwPrslp39v"  # Enter your own API-key here
        self.binance_api_secret = "hmxNYXa0zJiRVEZ8m98ocYLN33Suj0pERR8b5XKBFIadAy5kWs1wxT1EQlPzuWOn"  # Enter your own API-secret here
